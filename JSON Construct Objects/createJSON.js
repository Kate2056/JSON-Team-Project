...
localStorage.setItem("studentOne", JSON.stringify(studentOne));
localStorage.setItem("studentTwo", JSON.stringify(studentTwo));
localStorage.setItem("studentThree", JSON.stringify(studentThree));
