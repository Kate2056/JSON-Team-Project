...
let studentObjects = [JSON.stringify(studentOne), JSON.stringify(studentTwo), JSON.stringify(studentThree), JSON.stringify(studentFour)];

localStorage.setItem("studentObjects", JSON.stringify(studentObjects));
